...
# -*- coding: utf-8 -*-
"""
This program takes a network that was trained using the pretext task of determining relative location image patches, 
...
def main():
    ...
    start_path = 'relpatloc.pt'
    save_path = 'classifier.pt'

    # Existing network is a DualResNet
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title(f"Classification loss using using patch location")
    plt.savefig("class_patloc_loss.pdf")
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.title(f"Classification accuracy using patch location")
    plt.savefig("class_patloc_acc.pdf")
